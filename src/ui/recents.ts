...
export class RecentsStateProvider implements vscode.Disposable {
  private readonly onDidChangeRecentsEventEmitter =
...
@Injectable()
export class RecentsTreeDataProvider
  implements vscode.TreeDataProvider<RecentEntry>, vscode.Disposable
{
  private readonly onDidChangeTreeDataEventEmitter =
    new vscode.EventEmitter<void>();
  ...
  getChildren() {
    return this.recentsState.recents.sort(
      (next, prev) => next.date - prev.date,
    );
  }
  ...
  constructor(
    ...
    this.disposable = vscode.Disposable.from(
      ...
      vscode.commands.registerCommand(
        CommandId.RefreshRecents,
        treeDataProvider.refresh,
        treeDataProvider,
      ),
      vscode.commands.registerCommand(
        CommandId.ClearRecents,
        recentsState.clearRecents,
        recentsState,
      ),
      vscode.commands.registerCommand(
        CommandId.RemoveRecent,
        this.removeRecent,
        this,
      ),
    );
